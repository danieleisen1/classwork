...
public class ObjectMain {
	...
	private void analyzeCommonalities(Person[] people, Person[] group) {
		...
		System.out.println("After " + trials +" trails, shuffling " + people.length + " people, on average, " + averageCommonality + " people end up in the same position where they started.");
	}
